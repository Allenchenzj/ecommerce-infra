...
- **`test_table_outputs`** (`command = apply`)
  ...
  - Checks table keys exist: `raw_customers`, `raw_stores`
...
- **`test_pipe_outputs`**
  ...
  - Checks pipe keys exist: `raw_customers`, `raw_stores`

- **`test_pipe_naming`**
  - Validates pipe names: `test_raw_customers_pipe`, `test_raw_stores_pipe`
...
- **Tables**: `test_{table_name}` (e.g., `test_raw_customers`)
- **Stages**: `test_{stage_name}` (e.g., `test_ecommerce_stage`)
- **Pipes**: `test_{table_name}_pipe` (e.g., `test_raw_customers_pipe`)
